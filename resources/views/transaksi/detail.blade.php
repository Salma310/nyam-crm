                ...
                <table class="table table-striped table-bordered mb-0">
                    ...
                    <tfoot>
                        <tr class="total-row">
                            ...
                            <td colspan="3"><strong>Rp. {{ number_format($transaksi->diskon_transaksi, 0, ',', '.') }}</strong>
                            </td>
                        </tr>
                        <tr class="total-row">
                            <td colspan="6"><strong>Pajak</strong></td>
                            <td colspan="3"><strong>Rp. {{ number_format($transaksi->pajak_transaksi, 0, ',', '.') }}</strong>
                            </td>
                        </tr>
                        <tr class="total-row" style="background:#e7f3fc;">
                            <td colspan="6"><strong>Total Penjualan</strong></td>
                            <td colspan="3"><strong>Rp. {{ number_format($totalSemua, 0, ',', '.') }}</strong></td>
                        </tr>
                        <tr class="total-row">
